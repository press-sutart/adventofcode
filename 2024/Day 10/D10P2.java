...
public class D10P2 {
    ...
    public static class MemoReachableNines {
        ...
        private HashMap<Coords, Integer> memoResults;
        private int rows;
        private int cols;
        ...
        public Integer getReachableNines(Coords co) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (inBounds(nextco) && readGrid(co) + 1 == readGrid(nextco)) {
                    temp += getReachableNines(nextco);
                }
            }

            memoResults.put(co, temp);
            return temp;
        }
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                if (inputGrid.get(r).get(c) == 0) {
                    ...
                    total += fun.getReachableNines(co);
                }
            }
        }
